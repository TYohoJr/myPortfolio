        ...
        return (
            <div id="bakerysite-div" className="project-div">
                <div className="project-info">
                    <p>MVP created on April 26th, 2018</p>
                    ...
                    The order page features a form to fill out to place an order for a cake. The order placement is contigent on a successful deposit of 10 dollars. This deposit is made using the PayPal API. Upon a successful deposit the form is submitted and saved into a postgreSQL database.
                    The final page displays examples of previous cakes. The main technologies used are React, Redux, Node, Express, postgreSQL, Google Maps API, PayPal API, and ReactStrap.</p>
